...
media = sum(dia['valor'] for dia in faturamento_diario)  / len(faturamento_diario)
faturamento_maior = [dia for dia in faturamento_diario if dia['valor'] > media]
dias_acima_media = [dia for dia in faturamento_diario if dia['valor'] > media]
...
print('Os dias com faturamento acima da média mensal foram:')
